  ...
  <Layout title="Works">
    <Container>
      ...
      <SimpleGrid columns={[1, 1, 2]} gap={6}>
        <Section>
          <WorkGridItem id="Crypto" title="Crypto App" thumbnail={thumbCrypto}>
            Description Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptatibus, laborum!
          </WorkGridItem>
        </Section>
        {/* <Section>
          <WorkGridItem
      ...
      <SimpleGrid columns={[1, 1, 2]} gap={6}>
        <Section delay={0.5}>
          <WorkGridItem id="exampless" thumbnail={thumbCrypto} title="exampless">
